...
function App() {
  ...
  return (
    <div>
    <div className='w-full h-[200px] absolute top-[2380px] bg-gradient-to-br from-indigo-900 to-blue-500'></div>
    <AppContainer>
      <Wrapper>
        <Marquee>
          <MarqueeGroup>
    ...
    <div className="w-full absolute top-[2740px] bg-gradient-to-br from-blue-500 to-indigo-900 h-[200px] z-10"></div>
   </div>
  );
}
